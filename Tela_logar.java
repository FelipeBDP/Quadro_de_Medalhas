...
public class Tela_logar extends JDialog implements ActionListener
{
   ...
   private JTextField tbxmatricula;
   ...
   public Tela_logar()
   {
       ...
       criarBotao("Ok");
       criarBotao("Cancelar");
       tbxmatricula = criarEntrada("Matricula",10);
   ...
   {
	  tbxmatricula.setText(""+a.getmatricula());
